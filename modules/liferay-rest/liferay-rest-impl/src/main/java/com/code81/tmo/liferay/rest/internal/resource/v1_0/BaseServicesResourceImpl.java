...
public abstract class BaseServicesResourceImpl implements ServicesResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/liferay-rest/v1.0/services'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(description = "Retrieve Services")
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseServicesResourceImpl.class);
